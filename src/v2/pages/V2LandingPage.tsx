        ...
        <V2Layout>
            <main>
                ...
                <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
                    ...
                    {/* Gradient overlay */}
                    <div className="absolute inset-0 bg-gradient-to-b from-[#040814]/85 via-[#040814]/60 to-[#020508]" />
                    ...
                    <div className="relative z-10 w-full max-w-7xl mx-auto px-4 text-center space-y-12">
                        ...
                        <ScrollReveal delay={400}>
                            <div className="flex flex-col items-center justify-center gap-4 pt-12">
                                <span className="font-aerospace text-[10px] font-bold uppercase tracking-[0.5em] text-cyan-400/60 animate-pulse">
                                    Scroll to learn more
                                </span>
                                <div className="w-[1px] h-16 bg-gradient-to-b from-cyan-400 to-transparent mt-4 opacity-50 relative overflow-hidden">
                                    <div className="absolute top-0 left-0 w-full h-1/2 bg-white/20 animate-scroll-line" />
                                </div>
                            </div>
                        </ScrollReveal>
                    </div>
                ...
                <section className="py-32 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-[#020508] to-[#030a10]" />
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {[
                                    ...
                                    <ScrollReveal key={idx} delay={idx * 150}>
                                        <div className={`h-full p-8 border bg-white/[0.02] backdrop-blur-sm space-y-5 hover:bg-white/[0.04] transition-all hover:-translate-y-1 ${item.color === 'red' ? 'border-red-500/20 hover:border-red-500/50 hover:shadow-[0_8px_32px_rgba(239,68,68,0.12)]' :
                                            ...
                                            <item.icon className={`w-8 h-8 ${item.color === 'red' ? 'text-red-500' :
                                                item.color === 'orange' ? 'text-orange-400' : 'text-yellow-400'
                                                }`} />
                                            <div>
                                                <div className={`font-aerospace text-5xl font-black ${item.color === 'red' ? 'text-red-400' :
                                                    item.color === 'orange' ? 'text-orange-400' : 'text-yellow-400'
                                                    }`}>{item.stat}</div>
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={idx} className="flex items-center justify-between p-4 border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors">
                                            ...
                                            <span className={`font-aerospace font-bold text-sm ml-4 text-right ${item.color === 'red' ? 'text-red-400' :
                                                item.color === 'orange' ? 'text-orange-400' : 'text-yellow-400'
                                                }`}>{item.value}</span>
                                        </div>
                                    ))}
                ...
                <section className="py-32 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-[#030a10] to-[#040814]" />
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                <ScrollReveal key={idx} delay={idx * 100}>
                                    <div className={`h-full p-8 border bg-white/[0.02] space-y-4 hover:bg-white/[0.04] transition-all hover:-translate-y-1 ${item.color === 'cyan'
                                        ...
                                        <div className={`w-12 h-12 flex items-center justify-center ${item.color === 'cyan' ? 'bg-cyan-500/10 text-cyan-400' : 'bg-purple-500/10 text-purple-400'
                                            }`}>
                ...
                <section className="py-28 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-[#040814] to-black" />
                    ...
                    <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
                        ...
                        {/* â”€â”€â”€ DESKTOP TIMELINE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                        <ScrollReveal delay={200}>
                                    ...
                                    {roadmapPhases.map((item, idx) => {
                                        ...
                                        return (
                                            <div key={idx} className="flex flex-col">
                                                {/* â”€â”€ Card â”€â”€ */}
                                                <div className={`relative p-5 border flex flex-col gap-3 transition-all group hover:-translate-y-1 ${isDone ? 'border-sky-500/30 bg-sky-500/5 hover:border-sky-400/60 hover:shadow-[0_8px_32px_rgba(14,165,233,0.15)]' :
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <span className={`font-aerospace font-black text-xs tracking-[0.3em] ${isDone ? 'text-sky-400' : isOngoing ? 'text-cyan-400' : 'text-zinc-600'
                                                    ...
                                                    {/* Phase name */}
                                                    <h3 className={`font-aerospace font-bold text-[11px] uppercase tracking-widest leading-relaxed ${isDone ? 'text-white' : isOngoing ? 'text-cyan-200' : 'text-zinc-500'
                                                        }`}>{item.label}</h3>
                                                    ...
                                                    {/* Date / status footer */}
                                                    <div className={`mt-auto pt-3 border-t flex items-center justify-between ${isDone ? 'border-sky-500/20' : isOngoing ? 'border-cyan-400/20' : 'border-white/5'
                                                        }`}>
                                                ...
                                                {/* â”€â”€ Connector line below card to timeline â”€â”€ */}
                                                <div className={`mx-auto w-[2px] h-8 ${isDone ? 'bg-sky-500/50' : isOngoing ? 'bg-cyan-400/50' : 'bg-white/10'
                                                    }`} />
                        ...
                        {/* â”€â”€â”€ MOBILE TIMELINE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                        <div className="lg:hidden space-y-4 mt-8">
                            {roadmapPhases.map((item, idx) => {
                                const isDone = item.status === 'done';
                                const isOngoing = item.status === 'ongoing';
                                return (
                                    <div key={idx} className={`flex items-start gap-4 p-5 border transition-colors ${isDone ? 'border-sky-500/30 bg-sky-500/5' :
                            ...
                            <div className="relative p-16 md:p-24 space-y-10 h-full flex flex-col justify-center">
                                <ScrollReveal>
                                    <div className="space-y-4">
                                        ...
                                        <h2 className="font-aerospace text-4xl md:text-5xl font-black uppercase tracking-tighter leading-[0.9] text-white">Cosmic <br />Memory <br />Registry</h2>
                                    </div>
                                </ScrollReveal>
