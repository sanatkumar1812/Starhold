        ...
        <V2Layout>
            <main>
                ...
                <section className="py-32 relative overflow-hidden">
                    ...
                    {/* Gradient fade to next section */}
                    <div className="absolute bottom-0 inset-x-0 h-40 bg-gradient-to-b from-transparent to-[#030a10] pointer-events-none z-20" />
                ...
                <section className="py-32 relative overflow-hidden">
                    ...
                    {/* Gradient fade to next section */}
                    <div className="absolute bottom-0 inset-x-0 h-40 bg-gradient-to-b from-transparent to-[#040814] pointer-events-none z-20" />
                ...
                <section className="py-28 relative overflow-hidden">
                    ...
                    {/* Gradient fade to next section */}
                    <div className="absolute bottom-0 inset-x-0 h-40 bg-gradient-to-b from-transparent to-black pointer-events-none z-20" />
